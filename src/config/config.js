...
export default {
  ...
  /**
   * @memberof module:config
   * @property {Array<Integer>} reject_hash_algorithms Reject insecure hash algorithm {@link module:enums.hash}
   */
  reject_hash_algorithms: new global.Set([enums.hash.md5, enums.hash.ripemd]),
  /**
   * @memberof module:config
   * @property {Array<Integer>} reject_message_hash_algorithms Reject insecure message hash algorithm {@link module:enums.hash}
   */
